 ...
 */
public class ResearchSubUniverseExpandableAdapter extends BaseExpandableListAdapter {

    ResearchUniverse mUniverse = null;
    Context mContext = null;
    public LayoutInflater inflater;
    IUniverseClickListener listener;
    public ResearchSubUniverseExpandableAdapter(Context context, ResearchUniverse universe, IUniverseClickListener clickListener) {
    ...
    public int getChildrenCount(int groupPosition) {
        if (((ResearchUniverse) getGroup(groupPosition)).getSubUniverses() != null) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View v, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.item_research_category_child_group, null);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
      ...
      /*  } else {
            universeHolder = (UniverseHolder) v.getTag();
        }*/

        //ResearchUniverse category = (ResearchUniverse) getGroup(groupPosition);
